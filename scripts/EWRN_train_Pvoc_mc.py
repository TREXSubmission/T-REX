"""Script for training equivariant WideResnet for multilabel PascalVOC classification"""
import os
...
from config.EWRN_Pvoc_mc import EWRNPvocMC
from src.datasets.Pvoc import PvocClassificationDataModule
from src.modules.EWRN_classification import EWRNClassificationModule
...
def main():
    ...
    dm = PvocClassificationDataModule(
    ...
    model = EWRNClassificationModule(config)

    callbacks = get_training_callbacks(config, log_path, experiment_name, equivariant=True)
